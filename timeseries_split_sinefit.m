function [ signal_cycles, total_output_offset ] = timeseries_split_sinefit(reference, signal, sampling_freq)
...
[ main_freq, main_phase ] = extract_main_frequency_and_phase( reference, sampling_freq );
